...
function createGrid(container) {
  ...
  gridView.registerCustomRenderer("custom_check", {
    ...
    render: function(grid, model, w, h) {
        ...
        //*** expression에 대한 조건식을 여기서 설정 */
        this._check.disabled = model.index.itemIndex < 2;
  ...
  setTimeout(function() {gridView.setCheckableExpression("row > 1", true)}, 100);

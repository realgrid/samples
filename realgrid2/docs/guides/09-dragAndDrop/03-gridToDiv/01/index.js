...
function setDropOther(){
  var checked = document.getElementById("checkbox_DropOther").checked;
  gridView.dataDropOptions.dropOtherElement = checked;
  gridView.dataDropOptions.callback = checked?  (source, items, target, targetIndex, targetCell) => {

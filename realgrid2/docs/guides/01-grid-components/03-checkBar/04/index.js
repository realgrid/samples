...
function btnCheckableExpression(){
  gridView.setCheckBar({
    checkableExpression: "values['Gender'] = '남'"
  });
}

function btnApplyCheckables(){
  gridView.applyCheckables();
}

function btnSetCheckableExpression(){
  gridView.setCheckableExpression("row < 5", true);
}

function btnResetCheckables(){

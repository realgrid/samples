...
function btnAddLayoutColumn(){
  if(gridView.layoutByColumn("Monetary") == null){
    gridView.addLayout("Monetary");
  }
}

function btnRemoveLayoutColumn(){
  if(gridView.layoutByColumn("Monetary") !== null){
    gridView.removeLayout("Monetary");
  }
}

function btnAddLayoutGroupColumn(){
  if(gridView.layoutByColumn("KorCountry") == null){
    gridView.addLayout({name: "GroupColumn2", items:["KorCountry"]});
  }
}

function btnRemoveLayoutGroupColumn(){
  if(gridView.layoutByColumn("KorCountry") !== null){
    gridView.removeLayout("KorCountry");
  }
}
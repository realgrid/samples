...
function btnUnGroupBy() {
  gridView.groupBy([]);
}

function btnIsGrouped() {
  alert(gridView.isGrouped());
}

function btnIsMergedGrouped() {
  alert(gridView.isMergedGrouped());
}

function btnGetGroupFields() {
  alert(gridView.getGroupFields());
}

function btnGetGroupFieldNames() {
  alert(
    gridView.getGroupFieldNames(
      document.getElementById("chkOrgFieldName").checked
    )
  );
}

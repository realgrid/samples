...
function btnSetRowState() {
  var curr = gridView.getCurrent();
  var rbRowState = document.getElementsByName("rbRowState");
  var state;
  for(var i = 0; i < rbRowState.length; i ++){
    if(document.getElementsByName("rbRowState")[i].checked){
      state = document.getElementsByName("rbRowState")[i].value
    }
  }
  dataProvider.setRowState(curr.dataRow, state, true);
}

function btnSetRowStates() {
...
function btnRowStateCount() {
  var rbRowState = document.getElementsByName("rbRowStateCount");
  var state;
  for(var i = 0; i < rbRowState.length; i ++){
    if(document.getElementsByName("rbRowStateCount")[i].checked){
      state = document.getElementsByName("rbRowStateCount")[i].value
    }
  }

...
function getValues() {
  var current = gridView.getCurrent();
  alert(
    "itemIndex: " + current.itemIndex + "\n" + JSON.stringify(gridView.getValues(current.itemIndex))
  );
}
...
function getDisplayValues() {
  ...
  alert("itemIndex: " + current.itemIndex + "\n" + JSON.stringify(jsonData));
}

function getDisplayValuesOfRow() {
  var current = gridView.getCurrent();
  var jsonData = gridView.getDisplayValuesOfRow(current.dataRow);
  alert("dataRow: " + current.dataRow + "\n" + JSON.stringify(jsonData));
}
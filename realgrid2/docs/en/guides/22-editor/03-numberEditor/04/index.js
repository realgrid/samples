...
function loadData() {
  if (httpRequest.readyState === XMLHttpRequest.DONE) {
    if (httpRequest.status === 200) {
      ...
      dataProvider.setValue(8, 'Quantity', -100);
      dataProvider.setValue(9, 'Quantity', -10000);
      dataProvider.setValue(10, 'Quantity', -100.1);
      dataProvider.setValue(11, 'Quantity', -1000.12);
      dataProvider.setValue(12, 'Quantity', -1000.1234);
      dataProvider.setValue(13, 'Quantity', -1000.1237);
      dataProvider.setValue(14, 'Quantity', -5544444.55555);
      dataProvider.setValue(15, 'Quantity', -12345.4423);
      gridView.refresh();
    }
  }
}
...
function btnNumberFormat() {
    gridView.setColumnProperty("Quantity","numberFormat","#,##0.##;,;.");
}
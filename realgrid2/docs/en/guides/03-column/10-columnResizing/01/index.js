...
function btnToggleGlobalColumnResizable() {
  var options = gridView.getDisplayOptions();

  options.columnResizable = !options.columnResizable;
  gridView.setDisplayOptions(options);
  if(options.columnResizable = !options.columnResizable){
    document.getElementById("globalColumnResizable").innerHTML = "모든 컬럼 크기변경 가능"
  }else{
    document.getElementById("globalColumnResizable").innerHTML = "모든 컬럼 크기변경 불가능"
  }
}

function btnToggleColumnResizable() {

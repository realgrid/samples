...
function replacer(key, value) {
  if (key == 'startLayout' || key == 'endLayout') {
  return undefined;
}
  return value;
}
function btnGetSelectionInfo() {
  addLog(JSON.stringify(gridView.getSelections(), replacer))
}

function btnGetSelectionData() {
  addLog(JSON.stringify(gridView.getSelectionsData()))
}
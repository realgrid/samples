...
$().ready(function () {
    ...
    setTests("actions", "TreeSetXmlData");
...
function setData() {
    ...
    dataProvider.setXmlRows(rows, "row", "", "icon");
...
var tests = {
    rowCount: function () {
        alert(dataProvider.getRowCount());
    },
    expandAll: function () {
        treeMain.expandAll();
    },
    setFilters: function () {
        var column = treeMain.columnByField("Col1");
        if (column) {
            treeMain.setColumnFilters(column, [{
                name: "전문가",
                criteria: "value > 10000",
                active: false
            }]);
    ...
    setCheckableExpr: function () {
        treeMain.setCheckableExpression("value['col3'] <= 1000",true);
    },
    setCheckable: function () {
        treeMain.setCheckable(0, false);
        treeMain.checkAll(true, false, true);
    },
    resetCheckables: function () {
        treeMain.resetCheckables();
    },
    getTreeOptions: function () {
        var options = treeMain.getTreeOptions();
...
function setTests(container, title) {
    ...
    createCheckBox(container, "showCheckBar", function (e) {

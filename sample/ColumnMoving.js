...
var tests = {
	toggleMovable: function () {
		...
		if (column) {
			//grdMain.setColumnProperty(column, "movable", !column.movable);
			column.movable = !column.movable;
	...
	changeIndex: function () {
		var column = getSelected();
		if (column) {
			var newIdx = $("#txtSub").val();
			column.displayIndex = newIdx;
			grdMain.setColumn(column);
		}
	}
};
...
function setTests(container, title) {
	...
	createCheckBox(container, "columnMovable", function (e) {
		grdMain.setDisplayOptions({ columnMovable: _getChecked(e) });
	}, true);
	createCheckBox(container, "parentChangable", function (e) {
		grdMain.setDisplayOptions({ parentChangable: _getChecked(e) });
	}, false);
